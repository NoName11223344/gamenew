                    ...
                    @csrf
                        <div class="col-md-6 mb-4">
                            <div class="form-outline">
                                ...
                                <input type="text" id="bank_no" name="bank_no" class="form-control" value="{{ old('bank_no') }}">
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="form-outline">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="form-outline">
                                ...
                                <input type="text" id="bank_short_name" name="bank_short_name" class="form-control" value="{{ old('bank_short_name') }}">
                            </div>
                        </div>
